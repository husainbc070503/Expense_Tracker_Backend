...
import { Register, Login, PasswordChange, SendOtp } from "../validators/AuthValidator.js"
...
const sendMail = async (email, message) => {
    ...
    const options = {
        ...
        to: email,
        subject: 'Expense Tracker Mail Service System',
        html: message
    }
...
router.put('/updatePassword', ValidateInput(PasswordChange), async (req, res) => {
    try {
        ...
        if (validOtp) {
            ...
            sendMail(email, "<h4>Your password for the Expense Tracker Web App has been updated. Please login and verify. <br> If it wasn't you then please contact us immediately. Thank you</h4>");
            res.status(200).json({ success: true, user });
